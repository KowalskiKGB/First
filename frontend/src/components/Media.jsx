...
export default function Media({ ex, id, compact, minimizable }) {
  const [playing, setPlaying] = useState(autoplayMedia)
...
export function Thumb({ ex }) {
  ...
  return <img className="thumb" width="50" height="50" loading="lazy" decoding="async" src={imgSrc(ex)} alt="" onError={() => setBroken(true)} />
}
