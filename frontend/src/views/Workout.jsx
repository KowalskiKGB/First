...
import { lastEntryFor, bestWeightFor, buildSets, setsDoneActive, supersetUnits, unitOf, setLabel, modeOf, isBw, isPerSide, sideReps, repStep, EFFORT, effortOf, stepEffort, capEffort } from '../lib/history.js'
...
function StartChooser() {
  ...
  const todayR = todayOptions[0]?.routine || null
...
function ExerciseBlock({ entryIdx, compact, onToggle, onField, onAddSet, onRemoveSet, onStartTimed }) {
  ...
  return <>
    ...
    <div className="row between" style={{ marginBottom: 6 }}>
      <div className="capitalize exercise-name" style={{ fontSize: compact ? 17 : 20, fontWeight: 600, letterSpacing: '-.02em', lineHeight: 1.2 }}>{exerciseName(ex)}</div>
    ...
    <PrescribedNote target={entry.target} />
