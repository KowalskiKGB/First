...
import { exerciseName, getLang, t } from '../lib/i18n.js'
...
export default function Stats() {
  ...
  const exHist = [...new Set(S.workouts.flatMap(w => w.entries.map(e => e.id)))].filter(id => EXIDX[id]).sort((a, b) => exerciseName(EXIDX[a]).localeCompare(exerciseName(EXIDX[b]), getLang()))
