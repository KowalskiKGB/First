...
test('release backup and restore fail closed around the single JSON writer', () => {
  ...
  assert.match(runbook, /parada do\s+writer[\s\S]{0,80}confirmada|writer stop cannot be confirmed/i)
})
